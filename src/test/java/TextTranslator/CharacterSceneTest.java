...
public class CharacterSceneTest extends CharacterScene {
    private static final CharacterScene mockList = new CharacterScene(Arrays.asList(
            new Dialogue("Mom", "This is a text", 3, 3, 3, 35),
            new Dialogue("Mom", "This is a text also", 3, 3, 3, 35),
            new Dialogue("Mom", "This is a text also", 3, 3, 3, 33),
            new Dialogue("Mom", "This is a text also", 3, 10, 3, 36),
            new Dialogue("Mom", "This is a text also", 3, 10, 3, 35),
            new Dialogue("Dad", "This is a text also", 3, 3, 3, 35)));
    ...
    public void testCheckContains() {
        ...
        Assert.assertFalse(this.checkContains(
                new Dialogue("Grandma", "This is a text", 3, 3, 3, 35),
                mockList));
    }
