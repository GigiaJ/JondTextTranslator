...
public class CharacterSceneHandlerTest extends CharacterSceneHandler {
    ...
    public void testPlaceCommands() {
        ...
        for (int i = 1; i < mockScenes.size() + 1; i++)
            mockScenes.get(i - 1).add(new Dialogue("Mom", "Sample Text", i, i, i, i));
    ...
    public void testIterateThroughAllScenesAndDialogueUntilMatch() {
        ...
        for (CharacterSceneMatch scene : mockScenes) {
            for (int i = 1; i <= EXPECTED_ROW + 1; i++) {
                scene.add(new Dialogue("Mom", "Sample Text", i, i, i, i));
            }
        }
    ...
    public void testIterateThroughScene() {
        ...
        for (int i = 1; i <= EXPECTED_ROW + 1; i++) {
            mockScene.add(new Dialogue("Mom", "Sample Text", i, i, i, i));
        }
    ...
    public void testEnterRowData() {
        ...
        Dialogue mockDialogue = new Dialogue("Speaker", "Random Text", 2, 2, 10, OUTPUT_SIZE);
    ...
    public void testAssignDialogueToScene() {
        Dialogue dialogue1 = new Dialogue("Mom", "This is a text", 3, 3, 3, 31),
                dialogue2 =
                        new Dialogue("Mom", "This is a text also", 3, 3, 3, 35),
                dialogue3 =
                        new Dialogue("Mom", "This is a text also", 3, 3, 3, 39),
                dialogue4 =
                        new Dialogue("Dad", "This is a text also", 3, 3, 3, 50),
                dialogue5 =
                        new Dialogue("Mom", "This is a text also", 3, 10, 3, 10),
                dialogue6 =
                        new Dialogue("Mom", "This is a text also", 3, 10, 3, 15);
    ...
    public void testSetSceneToCurrent() {
        ...
        Dialogue mockDialogue = new Dialogue("DifferentSpeaker", "Random Text", 2, 3, 15, 5);
    ...
    public void testIsNotCurrentScene() {
        ...
        Dialogue mockDialogue = new Dialogue(mockSpeaker, "Random Text", 2, mockTrigger, mockTalkTime, 5);
