...
public class FileHandlerTest extends FileHandler {
    ...
    public void testNormalize() {
        String mockLine = "[VAR PKNAME(0000)] [VAR PKNAME(0001)] [VAR PKNAME(0002)] [VAR PKNAME(0003)] [VAR PKNAME(0004)]"
                + " [VAR PKNAME(0005)] [VAR PKNICK(0000)] [VAR PKNICK(0001)] [VAR TRNAME(0000)] [VAR TRNAME(0001)] [VAR TRNICK(0000)] [VAR TRNICK(0001)] [VAR COLOR(0000)] [VAR COLOR(0001)] [VAR COLOR(0002)] \\n \\c";
        String expectedLine = "Pokémon Pokémon Pokémon Pokémon Pokémon Pokémon   @s @s @s @s      ";
    ...
    @Test
    public void testUpdateStringBuilder() {
        Assert.fail();
    }

    @Test
    public void testIterateThroughValuesAndUpdate() {
        Assert.fail();
    }
}
